...
def train_challenge_model(data_folder, model_folder, verbose):
    ...
    fittedModel = model_binary.fit(total_data, to_categorical(outcomes,num_classes=2), batch_size=16, epochs=50,callbacks=callback) 
    ...
    fittedModel = model_multiclass.fit(total_data, to_categorical(cpcs,num_classes=5), batch_size=16, epochs=50,callbacks=callback) 
